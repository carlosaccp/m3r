...
ax.set_title("ADAM OAIS with Mixture target and Gaussian proposal, iteration 0", fontsize=20)
...
def update(i):
    ...
    ax.set_title("ADAM OAIS with Mixture target and Gaussian proposal, iteration {}".format(i), fontsize=20)
    return cont
...
ani.save('AdamOAIS_mix.mp4', writer=writer)
print("done saving")
plt.show()
